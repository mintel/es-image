...
echo "Removing index recovery settings"
curl --retry 3 --connect-timeout 3 -s -XPUT -H 'Content-Type: application/json' "http://${DISCOVERY_SERVICE}:9200/_cluster/settings" -d "{ \"transient\" :{ \"indices.recovery.max_bytes_per_sec\" : null }}"
